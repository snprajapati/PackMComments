...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    reply: function reply(comment) {
      ...
      this.content = '';
      this.user = ''; // Getting Nested Parent
...
function getParent(parent) {
  if (typeof parent.replyTo === 'function') {
    return parent;
  } else {
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    replyTo: function replyTo(comment) {
      ...
      axios.post('/api/comment', comment).then(function (response) {
...
module.exports = __webpack_require__(/*! /Users/alkmy/Documents/TechEvaluation/PackMComments/commentsystem/resources/js/routes/index.js */"./resources/js/routes/index.js");
